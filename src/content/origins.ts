...
export const ORIGINS: readonly Origin[] = [
  ...
  },
  {
     ...
     * ## 籍是医户：史料那一层真，推断那一层软
     *
     * 【史料·《大明律·户律·户役·人户以籍为定》】「凡军、民、驿、灶、医、卜、工、乐
     * 诸色人户，并以籍为定。」——**医户确有其籍**，跟军民匠灶一样世袭，改籍要官府允准。
     * 这一层引得出条文。
     *
     * 【推断·过强】**但「开药铺」推不出「是医户」。** 审查表 3.1 明写着：
     * 医户供的是太医院和地方医学，而**一间镇上药铺更可能是民户或铺户里
     * 做药材生意的人家**。这一格现在写医户，是我们为「业和籍互相印证」
     * 这个效果定的——跟匠户那一行正好相反的一处对照。
     *
     * 留着不改，因为 `census` 四格眼下**零个条件读者**（`scripts/household.ts`
     * 盯着这个零），改不改没有内容后果。**第一个读者出现的那天要一并纠**：
     * 到那时「这家人是不是医户」会真的影响什么，而现在它只是一个词。
     */
    id: 'herb',
    census: '医户',
    livelihood: '行医',
