  ...
  'day:ordinary': {
    ...
    nodes: {
      ...
      morning: {
        ...
        /**
         * 「今天没有人指派你做什么」——这一句在不同人生里根本不是一个意思。
         *
         * 挑这一节，是因为它**最不像个事件**：一辈子会读到好几遍，
         * 平常得几乎没有内容。可正是这种地方最见人生。
         * 爹在外头做工的孩子，没人指派是因为该指派他的人不在；
         * 守过病榻的孩子，没人喊他就是今天家里没事——那是松一口气。
         *
         * 头一版这几句写在 `routine:teen#open`，看着也平常。
         * 走查一跑：三百世只有一世走到那一节。**写在读不到的地方，
         * 跟没写是一回事**，而正文完好、门禁全绿，没有任何东西会吭声。
         */
        seen: [
          {
            // 该指派你的人不在家。这跟「今天歇着」是两回事
            requires: [{ flag: { key: 'father-away' } }],
            text: '本该指派你的那个人不在家。',
          },
          {
            // 守过病榻的孩子，听见屋里没动静先松一口气
            requires: [{ flag: { key: 'sat-through-illness' } }],
            text: '屋里没有人喊你。今天家里没人不舒服。',
          },
          {
            // 家里紧的孩子，闲着的一天是要算钱的
            requires: [{ standing: { atMost: 35 } }],
            text: '闲着的一天也是一天。这个你算得清。',
          },
        ],
        choices: [
          {
