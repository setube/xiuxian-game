        ...
        choices: [
          ...
          },
          {
            ...
            effects: [
              ...
              /*
               * ⚠️ **年表这一笔是 2026-09-09 补的**，而它缺了不止一天。
               *
               * 同一节点的两个选项：跟着去那一支落了年表（「你跟着车队往北走了一趟」），
               * 没去这一支只落一面旗。**而上头那句注释自己写着「它是大多数人的选择」**
               * ——于是这一册里人数最多的那条路，在一个人的年表上一个字也没有。
               *
               * 这跟同一天在 `schooling.ts` 修的是同一个形状：那一册五笔年表全给了
               * 「念上书了」，而「供不起，跟着下地」一笔没有。**两处都是
               * 「事情没有发生」的那条路只有正文没有痕迹**，而那条路走的人更多。
               *
               * 分辨（22 归纳的）：**后果落在哪一侧**。
               *
               *     决定不去、决定不说、决定不管　→ 那是一件事，该记
               *     日子照旧、接着翻、没放在心上　→ 那不是事，不记
               *
               * 这一支属于前者：他说家里离不开，而那句话是真的。
               */
              { type: 'chronicle', text: '车队北上那一趟，你没有去。' },
            ],
            next: 'stayed',
          },
        ],
