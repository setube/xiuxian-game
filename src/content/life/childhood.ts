    ...
    nodes: {
      ...
      escort: {
        ...
        blocks: [
          ...
          { kind: 'narration', text: '坐在院里脱衣裳，背上一道口子，{dam}正在给他上药。' },
          { kind: 'narration', text: '你站在门槛上看。回头看见你，把衣裳拉了上去。' },
          { kind: 'dialogue', speaker: '{elder}', text: '没事。进去。' },
          { kind: 'narration', text: '那天夜里你听见{elder}跟{dam}说，往后那条道不走了。' },
          { kind: 'narration', text: '{dam}问为什么。没有答。' },
        ],
        next: 'close',
      },
      ...
      runner: {
        ...
        blocks: [
          ...
          { kind: 'narration', text: '进去点卯。出来的时候，腰牌不在腰上了。' },
          { kind: 'narration', text: '回家的路上没说话。' },
          { kind: 'event', text: '晚上{dam}问起，说是班头收了。' },
          { kind: 'narration', text: '过了三天，腰牌又挂回了门后。没说为什么。' },
        ],
        next: 'close',
      },
      ...
      court: {
        ...
        blocks: [
          ...
          { kind: 'narration', text: '后来{dam}带你去给{elder}问安。' },
          { kind: 'event', text: '你看见{dam}跪下了。' },
