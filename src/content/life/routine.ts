        ...
        choices: [
          ...
          },
          {
            ...
            effects: [
               ...
               *     走到老年那一卷        92.6%
               *     这一条可选（body≥45） 84.3%
               *     真的选了它            62.0%   ← 天年真的变了的比例
               *
               * 走到老年的人里三分之二选了它，选项开过的人里四分之三选了它。
               * **单印 62% 看不出它经过了三道筛**（17 提醒的：一个比例要连分母一起报）。
               *
               * ⚠️ 记在这儿是因为它被我连着写错过两次：
               * 先是**低估**（以为只影响少数人，于是把那两岁的差归错了地方），
               * 后是**认错了名字**——我凭印象把它叫成「熬夜伤身」，
               * 而它是老年这一卷的「再走一趟远路」，那个错名字当时已经传到三个文件六处。
               */
