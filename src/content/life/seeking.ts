...
export const seekingEvents: readonly LifeEvent[] = [
  ...
  },
  {
     ...
     * 就是一卷宽窗口、低门槛的事造成的。这一条要念头——头一版念头只在少年时长，一百个里两个；
     * 成年段「接着打听」点念头之后（`leanings.ts` 的 `kept-asking`），随便走的人百里六七个、
     * 有心人四个里一个（2026-09-08）。底下那条 `chance` 就是为这个加的。
     */
     ...
     * 是因为那几年天天收日、火种冷水都在跑，问空一回念头就退了；**成年段只有「接着打听」
     * 那一条点念头**（头一版一条也没有，念头几乎冻在十六岁那一刻：300 世里十六岁后念头有变化的
     * 166 世，变的都只是一两分）——起了念头的人念头多半一辈子在。0.25 按成年段七个回合算：
     * 还揣着那个念头的人成年后再问两回上下。
     */
    chance: 0.25,
  },
