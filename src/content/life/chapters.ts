...
export const CHAPTERS: readonly Chapter[] = [
   ...
   */
  {
    ...
    called: ['年表'],
    to: [],
    // 20 起：成亲中位 17 岁（600 世实测），这一册要的是「过了几年你才慢慢看见」。
    // 78 止：第二卷要等娘到 58 岁，那时玩家常在三十往后，链尾能拖到七十几
    age: [20, 78],
    purpose: [
      '「天天在场」不等于「没有生命周期」——她也有自己的做法',
      '性情那一格第一次有人读：全库娘 10 处、嫂子 2 处，而配偶从前是 0 处',
      '写她做的那件事然后停住，评价留给玩家自己下',
      '娘病的那半个月：过门那天立的那条边，在这儿第一次被读到',
    ],
    marks: [],
  },
  ...
  },
  {
    ...
    to: [],
    /*
     * 5–45：第一卷开在童年（东邻女主人的育龄卡着，玩家 8 岁时她 ≤40 的
     * 世界占 41.6%、20 岁只剩 2.5%），第二卷开在她长大之后
     * ——**那一段是她的年纪决定的，不是玩家的**：
     * 她出生时玩家 5–14 岁，她十八岁那年玩家二十几岁。
     */
    age: [5, 45],
    purpose: [
      '邻居头一次成为「发生了什么」的那个人，而不是来到你家门口的人',
      '玩家家之外的人口自然增长——这个世界本来就允许，只是从没有人写过',
      '那个孩子长大之后仍然在那儿——第一卷的开放承诺，由第二卷兑现',
    ],
    marks: ['meet'],
  },
