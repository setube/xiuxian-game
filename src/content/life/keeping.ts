    ...
    nodes: {
      ...
      'no-one': {
        ...
        blocks: [
          ...
          /*
           * ⚠️ **这儿从前写的是「你又找过写字的先生」，而那是穿帮。**
           *
           * `present` 那一支 2026-09-14 抓到：先生（`teacher`）立起来就 50 岁，
           * 而这一卷的窗口是 40–78——**玩家四十岁那年他八十开外，多半早殁了**。
           * 于是正文里一个已经不在的人还在跟他说话。
           *
           * 修法不是加一条「先生还在」的前提：那会让这一节在多数世界里
           * 演不到，而**这一节的意思跟具体是谁无关**——它说的是
           * 「他绕着问了一圈，谁也没听懂他在问什么」。
           *
           * 所以换成不点名的说法。**一个不需要具体人的句子，
           * 就不该写一个具体的人**——写了就得负责他那一年还在不在。
           */
          { kind: 'narration', text: '你又去过学堂门口，跟那边教书的绕着问了半天。' },
