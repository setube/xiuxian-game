 ...
 * 每比门槛多这么多分，往上够一格。
 *
 * 头一版是 8：药庐那位门槛 58，四格就是 58 / 66 / 74 / 82。那几个数是对着摆好的局配的
 * （`scripts/tutelage.ts` 的样本心志 94、手脚 86），没对过真世——真世里守家、打听、
 * 练力气优先走到二十八岁，心志中位 67、手脚中位 67，两者平均 ≥74 的两成、≥82 的
 * 不到一成，而念头只在少年时长、窗口到二十九岁为止。于是「教一点」在真世里 600 世 0 世
 * （2026-09-08，`scripts/ascent.ts`）。用户拍板拜师那条要走得通，台阶改成 4：
 * 58 / 62 / 66 / 70——门槛那一格（肯不肯守着）不动，「教一点」落在二十八岁那一批的
 * 中位之上、上四分位之下：**他还是只肯教沉得住的那一类人**，只是那一类人真世里生得出来了。
 * 先试过 5（教一点 73）：有心人 300 世走到「那五句」8 世、会了门路 1 世、自己坐过 0——
 * 最后一格仍是死的，念头在成年段才起，二十九岁窗口关前只剩四五个回合给这四格。
 * 观里那位跟着变（62 / 66 / 70），他的顶是「带一段」，走不到「教一点」这一格，没有影响。
 */
const A_STEP = 4
