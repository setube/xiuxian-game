 ...
 * 一生跑得完，而且每一段都真的有人在过。
 *
 * 跑法：`npx vite-node scripts/lifelong.ts`
 *
 * ## 这一道是被「十六岁结束」逼出来的
 *
 ...
 *
 * 六百世量下来：启蒙停过 12 世，少年停过 8 世。**这仍然是个位数**，
 ...
 */
const CULTIVATION_CHAPTER = 'riverman'
 ...
 */
const partings: readonly string[] = (() => {
 ...
 *
 * 这一条是补上去的，头一次跑就红了：`spouse` 六百世一个人也没走到。
